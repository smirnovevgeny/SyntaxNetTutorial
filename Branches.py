class Branches():
    ...
    class outputData:
        ...
        def addValues(self, SENTENCE_ID, BRANCH_ID, BRANCH, WORD_IDS_LOCAL, WORD_IDS_GLOBAL=None):
    ...
    def addValues(self, words, parent_ids, tags, sentence_id,  word_ids_local, word_ids_global=None, window_size=2,
                  addTags=True):
    ...
    def addDataFrame(self, data, addTags=True):
